...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Sooon.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Sooon -X kill
screen -S Sooon ./Sooon
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SooonTEAM/Files_Sooon/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSooonW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local Sooon_Msg = ''  
if msgs < 100 then 
Sooon_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Sooon_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Sooon_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Sooon_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Sooon_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Sooon_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Sooon_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Sooon_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Sooon_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Sooon_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Sooon_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Sooon_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Sooon_Msg = 'رب التفاعل'  
end 
return Sooon_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSooon(msg,data) -- بداية العمل
if msg then
...
if DevSooonW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Sooon_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevSooonW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevSooonW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevSooonW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevSooonW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevSooonW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ☤ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevSooonW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ☤ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevSooonW(msg) then 
send(msg.chat_id_, msg.id_, io.popen([[
linux_version=`lsb_release -ds`
memUsedPrc=`free -m | awk 'NR==2{printf "%sMB/%sMB {%.2f%}\n", $3,$2,$3*100/$2 }'`
HardDisk=`df -lh | awk '{if ($6 == "/") { print $3"/"$2" ~ {"$5"}" }}'`
CPUPer=`Sooon -b -n1 | grep "Cpu(s)" | awk '{print $2 + $4}'`
...
if text == 'تحديث السورس ❃' and DevSooonW(msg) then 
os.execute('rm -rf Sooon.lua')
os.execute('wget https://raw.githubusercontent.com/SooonTEAM/Sooon/master/Sooon.lua')
send(msg.chat_id_, msg.id_,' ☤ تم تحديث السورس \n ☤ لديك اخر اصدار لسورس النهاية\n ☤ الاصدار » { 1.3v}')
dofile('Sooon.lua')  
end
if text == 'الاصدار ❃' and DevSooonW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☤ اصدار سورس النهاية \n ☤ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevSooonW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☤ [تحديثات البوت](t.me/th3_3nd) \n ☤ [قناه السورس](t.me/SOURCENASA)')
end
if text == "ضع اسم للبوت ❃" and DevSooonW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ☤ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevSooonW(msg) then 
...
if text == 'المشتركين ❃' and DevSooonW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☤ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevSooonW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☤ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevSooonW(msg) then
...
if text == ("قائمه العام ❃") and DevSooonW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevSooonW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevSooonW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☤ ارسل الان اذاعتك؟ \n ☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevSooonW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☤ ارسل الان اذاعتك؟ \n ☤ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevSooonW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☤ ارسل الان اذاعتك؟ \n ☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevSooonW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☤ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevSooonW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☤ ارسل لي التوجيه الان")
return false
end 
if text == 'كلب نسخه الاحتياطيه ❃' and DevSooonW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevSooonW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevSooonW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'☤  عدد الجروبات الان » { '..#group..' }'..Sooonk..''..Sooon..'\n☤  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSooonW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevSooonW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSooonW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSooonW(msg) then
...
local Sooon1_Msg = database:get(bot_id.."Sooon1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Sooon1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Sooon_Msg and not Special(msg) then  
local Sooon_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Sooon_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSooonW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSooonW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSooonW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSooonW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☤ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevSooonW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ☤ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevSooonW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevSooonW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevSooonW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ☤ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevSooonW(msg) then  
...
database:sadd(bot_id.."Sooon:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Sooon:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."Sooon:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Sooon:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Sooon:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Sooon:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Sooon:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Sooon:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykaa_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."Sooon:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Sooon:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."Sooon:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."Sooon:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Sooon:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☤ عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "SOURCENASA")..")\n☤ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Sooon:teh"..msg.chat_id_).."} بجانب اسمك\n☤ عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
...
local SooonChengName = database:get(bot_id.."Sooon:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SooonChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SooonChengName..']')
database:del(bot_id.."Sooon:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SooonChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Sooon:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SooonChengUserName = database:get(bot_id.."Sooon:Cheng:UserName"..data.id_)
if not data.username_ then 
if SooonChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SooonChengUserName..']')
database:del(bot_id.."Sooon:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SooonChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Sooon:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SooonChengPhoto = database:get(bot_id.."Sooon:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SooonChengPhoto then 
send(msg.chat_id_, msg.id_, "حمسح صوره قبل ماسرقها😂🥺 ")
database:del(bot_id.."Sooon:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SooonChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Sooon:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text =[[
* 𓆩مرحب بك في سورس سون 𓆪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="t.me/so_ooon"},
},
{
...
if text == 'رفع نسخه الاحتياطيه' and DevSooonW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSooonW(msg) then    
dofile('Sooon.lua')  
send(msg.chat_id_, msg.id_, ' ☤ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSooonW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSooonW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSooonW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSooonW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSooonW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSooonW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSooonW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSooonW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSooonW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSooonW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSooonW(msg) then
...
if text == 'الملفات' and DevSooonW(msg) then
...
if DevSooonW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SooonTEAM/Files_Sooon/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSooonW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SooonTEAM/Files_Sooon/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSooonW(msg) then
...
if text == "مسح الملفات" and DevSooonW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ☤ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSooonW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSooonW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_Sooon(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Sooon, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Sooon, nil)
return false 
end
...
database:set(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☤ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Sooon1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Sooon1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☤ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Sooon1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Sooon1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Sooon1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☤ ارسل الكلمه الان")  
database:set(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Sooon1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Sooon1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Sooon1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Sooon1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Sooon1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Sooon1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☤ قائمة المنع \n≪━━━━━━𝐒𝐎𝐎𝐎𝐍𖠱²²♫ ━━━━━━≫\n"
for k,v in pairs(list) do  
local Sooon_Msg = database:get(bot_id.."Sooon1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Sooon_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevSooonW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ☤ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSooonW(msg) then
...
if text == 'تفعيل الاذاعه' and DevSooonW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSooonW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Sooon_Msg[math.random(#Sooon_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSooonW(msg) then 
...
if text == ("مسح ردود المطور") and DevSooonW(msg) then 
...
if text == ("ردود المطور") and DevSooonW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☤ قائمة ردود المطور \n≪━━━━━━𝐒𝐎𝐎𝐎𝐍𖠱²²♫ ━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSooonW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevSooonW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevSooonW(msg) then   
...
if text == 'تعطيل المغادره' and DevSooonW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☤ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Sooon')..') '
...
-- vardump(data) 
Sooondx(msg.chat_id_, msg.id_, ' ☤ ايدي المجموعة » ( '..msg.chat_id_..' )\n ☤ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ☤ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ☤ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSooonW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ☤ٴ≪━━━━━━𝐒𝐎𝐎𝐎𝐍𖠱²²♫ ━━━━━━≫ٴ☤○ٴ\n☤ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/SOURCENASA)➢ ')
end
...
Sooon = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Sooon)
...
--------------------------------------------------------------------------------------------------------------
SourceSooon(data.message_,data)
...
------------------------------------------------------------------------
local SooonAbot = database:get(bot_id.."Sooon1:Add:Filter:Rp2"..text..result.chat_id_)   
if SooonAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☤ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☤ ["..SooonAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Sooon1_Msg = database:get(bot_id.."Sooon1:Add:Filter:Rp2"..text..result.chat_id_)   
if Sooon1_Msg then    
send(msg.chat_id_, msg.id_," ☤ "..Sooon1_Msg)
